...
------------
   ...
   1) Install Notepad++ (7.2 at the moment), in it's non x64 flavour as it's not yet complete.
...
To automatically select SerialEM language, just give ".sem" file extension of your script files.
